...
To create the project Structure follow the below steps :
1. Create a python file in any name, here I used template.py
2. Copy the below contents :
    ```
    import os
    ...
    ```
3. In the terminal : python template.py